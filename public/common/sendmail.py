...
logger = Log()
# 配置收发件人
# recvaddress = ['chengdongdong@ctzg.com','shiqq@ctzg.com']
recvaddress = ['chengdongdong@ctzg.com','shiqq@ctzg.com']
# 163的用户名和密码
sendaddr_name = 'chengdongdong@ctzg.com'
sendaddr_pswd = 'Cdd@920625top'
...
class SendMail:
	...
	def send(self):
		...
		try:
			...
			#smtp = smtplib.SMTP('smtp.exmail.qq.com', 465)
